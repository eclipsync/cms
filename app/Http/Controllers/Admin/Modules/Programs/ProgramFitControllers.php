 ...
 *
 * @filesource  ProgramFitControllers.php
 *
...
class ProgramFitControllers extends Controller {
	...
	public function __construct() {
		parent::__construct(ProgramFit::class, 'modules.programs.program_fit');
	}
	...
	public function index() {
		...
		$this->table->label(' ');
		$this->table->addTabContent('<p>Tanggal Update Terakhir : ' . $this->dateInfo('view_report_data_summary_program_fit_master_region', $this->connection) . '</p>');
		$this->table->searchable(['period_string', 'cor', 'region', 'cluster']);
		$this->table->clickable(false);
		$this->table->sortable();
		...
		$this->table->label(' ');
		$this->table->addTabContent('<p>Tanggal Update Terakhir : ' . $this->dateInfo('view_report_data_summary_program_fit_master_cluster', $this->connection) . '</p>');
		$this->table->searchable(['period_string', 'cor', 'region', 'cluster']);
		$this->table->clickable(false);
		$this->table->sortable();
		...
		$this->table->label(' ');
		$this->table->addTabContent('<p>Tanggal Update Terakhir : ' . $this->dateInfo('view_report_data_summary_program_fit_master_sub_cluster', $this->connection) . '</p>');
		$this->table->searchable(['period_string', 'cor', 'region', 'cluster']);
		$this->table->clickable(false);
		$this->table->sortable();
		...
		$this->table->label(' ');
		$this->table->addTabContent('<p>Tanggal Update Terakhir : ' . $this->dateInfo('view_report_data_summary_program_fit_master_national', $this->connection) . '</p>');
		$this->table->searchable(['period_string', 'cor', 'region', 'cluster']);
		$this->table->clickable(false);
		$this->table->sortable();
